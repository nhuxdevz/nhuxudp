...
[Unit]
Description=UDPserver Service by DEVNHUX
...
menu_udp(){
echo "             $(msg -verd "[0]") $(msg -verm2 ">") $(msg -bra "\033[1;41m${a9:-XHUNZLIMITED}")  $(msg -verd "[$a]") $(msg -verm2 "> ${a90:-QUITAR TODOS}")"
    msg -bar
  else
    msg -bar
    echo "             $(msg -verd "[0]") $(msg -verm2 ">") $(msg -bra "\033[1;41m${a89:-VOLVER}")"
	...
	title "${a1:-SCRIPT DE CONFIGRACION UDPserver} MOD BY : DEVNHUX"
